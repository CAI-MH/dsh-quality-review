...
function collectKeywords(dir: string, keywords: Set<string>): void {
  let entries;
  try {
...
export function loadSopKeywords(dir: string): string[] {
...
export function matchesSop(userPrompt: string, keywords: string[]): boolean {
